...
public final class ImagePicker {
    ...
    private static int PICK_IMAGE_ID = -1;
     ...
     */
    public static void pickImage(Activity activity, int Activity_Result_ID) {
        String chooserTitle = activity.getString(R.string.pick_image_intent_text);

        pickImage(activity, chooserTitle, Activity_Result_ID);
    }
     ...
     */
    public static void pickImage(Activity activity, String chooserTitle, int Activity_Result_ID) {
        Intent chooseImageIntent = getPickImageIntent(activity, chooserTitle);
        PICK_IMAGE_ID = Activity_Result_ID;

...
namespace PHRMS.Web.Models
{
    ...
    public class Common
    {
        ...
        public static bool CreateLog(IHostingEnvironment appHostingEnvironment, string Query, String MessageType = "", string ControllerName = "")
        {
            try
            {
                ...
                if (DateTime.Now.Hour > 11)
                    ...
                    FileName = String.Format("DB_{0}{1}{2}_Morning.txt", DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day);
                ...
                string BasePath = appHostingEnvironment.WebRootPath;// HttpContext.Current.Server.MapPath("~/ApplicationLogs");// System.Configuration.ConfigurationManager.AppSettings["BaseFolderPath"].ToString();
                string DBLogFolder = BasePath + "\\ApplicationLogs\\Logs";
                if (ControllerName != "")
                {
                ...
                using (StreamReader reader = new StreamReader(appHostingEnvironment.WebRootPath + "\\Templates\\Bugs.html"))
                {
                    bodysignup1 = reader.ReadToEnd();
                }

                bodysignup1 = bodysignup1.Replace("{Title}", "");
